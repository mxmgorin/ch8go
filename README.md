...
- **CHIP-8 DB Integration**: Automatically applies the proper quirks and tickrate for each ROM using a built-in [metadata database](https://github.com/chip-8/chip-8-database)
